...
This module is the data half of the FullThrottle-style features:
...
class LapTelemetry:
    ...
    @property
    def full_throttle_pct(self) -> float:
        """Share of the lap *distance* spent at 95 %+ throttle.  Distance
        rather than time, so a slower lap isn't flattered by spending
        longer at full beans."""
